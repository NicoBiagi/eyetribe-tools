...
from .server import start_eyetribe_server
...
def ask_session_setup(
    default_monitor_width_cm=53.1,
    default_monitor_height_cm=29.9,
    default_participant_to_monitor_cm=60.0,
    default_eyetribe_to_monitor_cm=2.0,
    default_eyetribe_to_participant_cm=58.0,
):
    ...
    monitor_width_cm_var = tk.StringVar(value=str(default_monitor_width_cm))
    monitor_height_cm_var = tk.StringVar(value=str(default_monitor_height_cm))
    participant_to_monitor_cm_var = tk.StringVar(value=str(default_participant_to_monitor_cm))
    eyetribe_to_monitor_cm_var = tk.StringVar(value=str(default_eyetribe_to_monitor_cm))
    eyetribe_to_participant_cm_var = tk.StringVar(value=str(default_eyetribe_to_participant_cm))
